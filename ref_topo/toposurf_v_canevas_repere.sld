...
<!--
  ...
  nom du SLD : toposurf_v_canevas_repere
  
  couche source dans la base :  toposurf.v_canevas_repere
  layer cible du style       :  ref_topo:toposurf_v_canevas_repere
...
xmlns:ogc="http://www.opengis.net/ogc" xmlns:se="http://www.opengis.net/se" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance">
  <NamedLayer>
    <se:Name>ref_topo:toposurf_v_canevas_repere</se:Name>
    <UserStyle>
      <se:Name>toposurf_v_canevas_repere</se:Name>
        <se:Description>
