...
<!--
  ...
  nom du SLD : rmtr_ssol_telec
  
  couche source dans la base :  topossol.v_telec_mat
  layer cible du style       :  ref_fonds:rmtr_ssol_telec
...
<StyledLayerDescriptor version="1.1.0" 
 ...
 <NamedLayer>
    ...
    <UserStyle>
     <se:Name>rmtr_ssol_telec</se:Name>
     <se:Description>        
  ...
  <!-- 7740 - Chambre de forme complexe -->
     <se:FeatureTypeStyle>
        <se:Rule>
          <se:Name>RMTR Sous sol - Télécommunication - Chambre de forme complexe </se:Name>
 ...
 <!-- 7720 - Cable de transmission longue distance -->
     <se:FeatureTypeStyle>
        <se:Rule>
          <se:Name>RMTR Sous sol - Télécommunication - Cable de transmission longue distance </se:Name>
          <ogc:Filter xmlns:ogc="http://www.opengis.net/ogc">
            <ogc:PropertyIsEqualTo>
              <ogc:PropertyName>modele</ogc:PropertyName>
 ...
 <!-- 3531 - Extrémité de conduite -->
     <se:FeatureTypeStyle>
        <se:Rule>
          <se:Name>RMTR Sous sol - Télécommunication - Extrémité de conduite </se:Name>
          <ogc:Filter xmlns:ogc="http://www.opengis.net/ogc">
            <ogc:PropertyIsEqualTo>
              <ogc:PropertyName>modele</ogc:PropertyName>
 ...
 <!-- 3511 - Citerneau circulaire -->
     <se:FeatureTypeStyle>
        <se:Rule>
          <se:Name>RMTR Sous sol - Télécommunication - Citerneau circulaire </se:Name>
          <ogc:Filter xmlns:ogc="http://www.opengis.net/ogc">
            <ogc:PropertyIsEqualTo>
              <ogc:PropertyName>modele</ogc:PropertyName>
 ...
 <!-- 3501 - Chambre rectangulaire -->
     <se:FeatureTypeStyle>
        <se:Rule>
          <se:Name>RMTR Sous sol - Télécommunication - Chambre rectangulaire </se:Name>
          <ogc:Filter xmlns:ogc="http://www.opengis.net/ogc">
            <ogc:PropertyIsEqualTo>
              <ogc:PropertyName>modele</ogc:PropertyName>
