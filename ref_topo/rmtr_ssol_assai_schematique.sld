  ...
  <NamedLayer>
    ...
    <UserStyle>
     ...
     <!-- Chambre à sable -->
      <se:FeatureTypeStyle>
        <se:Rule>
          <se:Name>RMTR Sous sol - Assainissement schématique - Chambre à sable</se:Name>
     ...
     <!-- Stockage structures alvéolaires -->
      <se:FeatureTypeStyle>
        <se:Rule>
          <se:Name>RMTR Sous sol - Assainissement schématique - Stockage structures alvéolaires</se:Name>
          <ogc:Filter xmlns:ogc="http://www.opengis.net/ogc">
            <ogc:PropertyIsEqualTo>
              <ogc:PropertyName>modele</ogc:PropertyName>
     ...
     <!-- Stockage tuyaux surdimensionné -->
      <se:FeatureTypeStyle>
        <se:Rule>
          <se:Name>RMTR Sous sol - Assainissement schématique - Stockage tuyaux surdimensionné</se:Name>
          <ogc:Filter xmlns:ogc="http://www.opengis.net/ogc">
            <ogc:PropertyIsEqualTo>
              <ogc:PropertyName>modele</ogc:PropertyName>
     ...
     <!-- Bassin Tampon souterrain -->
      <se:FeatureTypeStyle>
        <se:Rule>
          <se:Name>RMTR Sous sol - Assainissement schématique - Bassin Tampon souterrain</se:Name>
          <ogc:Filter xmlns:ogc="http://www.opengis.net/ogc">
            <ogc:PropertyIsEqualTo>
              <ogc:PropertyName>modele</ogc:PropertyName>
     ...
     <!-- Dessableur -->
      <se:FeatureTypeStyle>
        <se:Rule>
          <se:Name>RMTR Sous sol - Assainissement schématique - Dessableur</se:Name>
          <ogc:Filter xmlns:ogc="http://www.opengis.net/ogc">
            <ogc:PropertyIsEqualTo>
              <ogc:PropertyName>modele</ogc:PropertyName>
      ...
      <se:FeatureTypeStyle>
        <se:Rule>
          <se:Name>RMTR Sous sol - Assainissement schématique - Réseaux abandonnées</se:Name>
      ...
      <se:FeatureTypeStyle>
        <se:Rule>
          <se:Name>RMTR Sous sol - Assainissement schématique - Conduite unitaire autre que circulaire</se:Name>
          <ogc:Filter xmlns:ogc="http://www.opengis.net/ogc">
            <ogc:And>
              <ogc:PropertyIsEqualTo>
                <ogc:PropertyName>modele</ogc:PropertyName>
