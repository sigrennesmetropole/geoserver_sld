...
<!--
  ...
  nom du SLD : rctr_surf_bati_batipriv_v
  
  couche source dans la base :  toposurf.v_batim_bati_prive
  layer cible du style       :  ref_topo:rctr_surf_bati_batipriv_v
  
  objet :
  RCTR Surface - Bati - Batiment prive
...
<StyledLayerDescriptor xmlns="http://www.opengis.net/sld" xmlns:ogc="http://www.opengis.net/ogc" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" version="1.1.0" xmlns:xlink="http://www.w3.org/1999/xlink"  xsi:schemaLocation="http://www.opengis.net/sld http://schemas.opengis.net/sld/1.1.0/StyledLayerDescriptor.xsd" xmlns:se="http://www.opengis.net/se">
  <NamedLayer>
    ...
    <UserStyle>
      <se:Name>rctr_surf_bati_batipriv_v</se:Name>
      <se:FeatureTypeStyle>
        <se:Rule>
          <se:Name>RCTR Surface - Bati - Batiment prive</se:Name>
          <!-- Echelle d'affichage -->
