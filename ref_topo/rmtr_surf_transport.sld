...
<!--
  ...
  nom du SLD : rmtr_surf_transport

  couche source dans la base :  toposurf.v_trans_mat
  layer cible du style       :  ref_topo:rmtr_surf_transport
...
<StyledLayerDescriptor version="1.1.0"
  ...
  <NamedLayer>
    <se:Name>ref_topo:rmtr_surf_transport</se:Name>
    <UserStyle>
      <se:Name>rmtr_surf_transport</se:Name>
      <se:Description>
