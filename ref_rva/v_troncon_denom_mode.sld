...
xmlns:ogc="http://www.opengis.net/ogc" xmlns:se="http://www.opengis.net/se" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance">
  <NamedLayer>
    ...
    <UserStyle>
      ...
      <se:Description>
        <se:Title>Mode de circulation</se:Title>
        <se:Abstract>Style faisant apparaître les modes de circulation (voiture, modes doux...)  des tronçons des voies</se:Abstract>
      </se:Description>
      <se:FeatureTypeStyle>

        <!-- Tronçons Automobile -->        
        <se:Rule>
          <se:Name>Mode automobile</se:Name>          
          <ogc:Filter>
