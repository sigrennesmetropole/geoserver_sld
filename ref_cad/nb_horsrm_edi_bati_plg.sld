...
<!--
  ...
  nom du SLD : nb_horsrm_edi_bati_plg
  
  couche source dans la base :  cadastre.horsrm_edi_bati
  layer cible du style       :  ref_cad:horsrm_edi_bati_plg
  
  objet :
  Style relatif aux bâtiments du cadastre des communes en dehors de Rennes Métropole mais en niveau de gris.
...
xmlns:ogc="http://www.opengis.net/ogc" xmlns:se="http://www.opengis.net/se" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance">
  <NamedLayer>
    ...
    <UserStyle>
      <se:Name>nb_horsrm_edi_bati_plg</se:Name>
      <se:Description>
