...
<!--
  ...
  couche source dans la base :  ref_fond:geo_ptcanv
    ...
    <UserStyle>
      ...
      <se:FeatureTypeStyle>
        ...
        <se:Rule>
          ...
          <se:Description>
            <se:Title>Bornes limites de commune</se:Title>
          </se:Description>
        ...
        <se:Rule>
          ...
          <se:Description>
            <se:Title>Point bornés pérenne ou cadastral de précision</se:Title>
          </se:Description>
        ...
        <se:Rule>
          ...
          <se:Description>
            <se:Title>Point borné de canevas cadastral ordinaire</se:Title>
          </se:Description>
