...
<!--
  ...
  nom du SLD : edi_anpt_pnt
  
  couche source dans la base :  cadastre.edi_anpt
  layer cible du style       :  ref_cad:edi_anpt_pnt
  
  objet :
  La couche edi_anpt regroupe toutes les annotations du plan cadastral.
  ...
  16/09/2014  |  Arnaud LECLERE      |  version initiale
      ...
      <FeatureTypeStyle>
        ...
        <Rule>
          ...
          <TextSymbolizer>
            ...
            <Fill>
              <CssParameter name="fill">#339900</CssParameter>
            </Fill>
          </TextSymbolizer>
        </Rule>
