...
<!--
  ...
  nom du SLD : commune_contour_rm_rouge_lgn
  
  couche source dans la base :  limite_admin.commune_contour
  layer cible du style       :  ladm_terri:commune_contour
  
  objet :
  Permet de n'afficher que les communes de Rennes Métropole par un trait rouge sans remplissage
...
<StyledLayerDescriptor version="1.0.0"
  ...
  <NamedLayer>
    ...
    <UserStyle>
      <!-- nom du style -->
      <Name>commune_contour_rm_rouge_lgn</Name>
      <!-- ce title apparaît dans la liste des styles dans le visualiseur -->
      <Title>Communes de Rennes Métropole : ligne rouge</Title>
      <!-- le résumé apparaît en tooltip sur le nom du style -->
      <Abstract>Style avec une ligne rouge moyennement épaisse.</Abstract>
