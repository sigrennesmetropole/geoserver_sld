...
<!--
  ...
  nom du SLD : ign_geofla_depart_plg
  
  couche source dans la base :  limite_admin.ign_geofla_depart
  layer cible du style       :  ladm_terri:ign_geofla_depart
...
xmlns:ogc="http://www.opengis.net/ogc" xmlns:se="http://www.opengis.net/se" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance">
  <NamedLayer>
    <se:Name>ladm_terri:ign_geofla_depart</se:Name>
    <UserStyle>
      <se:Name>ign_geofla_depart_plg</se:Name>
        <se:Description>
