  ...
  <NamedLayer>
    ...
    <UserStyle>
      <se:Name>deci_pei_type_pnt</se:Name>
        <se:Description>
          <se:Title>Points Eau Incendie - Type</se:Title>
         ...
         <se:PointSymbolizer>
            <se:Graphic>
              <se:Mark>
                ...
                <se:Fill>
                  <se:SvgParameter name="fill">#2a58e3<se:PointSymbolizer>
            <se:Graphic>
              <se:Mark>
                <se:WellKnownName>ttf://Equipements_PVI#${'U+00A3'}</se:WellKnownName>
          ...
          </se:PointSymbolizer></se:SvgParameter>
                </se:Fill>
