...
<!--
  ...
  layer cible du style       :  urba_fonc:peb
...
xmlns:ogc="http://www.opengis.net/ogc" xmlns:se="http://www.opengis.net/se" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance">
  <NamedLayer>
    <se:Name>urba_fonc:peb</se:Name>
    <UserStyle>
      <se:Name>peb_plg</se:Name>
        <se:Description>
          <se:Title>Style par défaut</se:Title>
          <se:Abstract>Style par défaut pour le plan d'exposition au bruit.</se:Abstract>
        </se:Description>
      <se:FeatureTypeStyle>
      
        <!-- polygone hâchuré bleu + bordure -->
 <se:Rule>
          <se:Name>Plan d'exposition au bruit (PEB) sur Rennes Métropole</se:Name>    
