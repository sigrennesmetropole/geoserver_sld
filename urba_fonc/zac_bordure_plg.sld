...
<!--
  ...
  objet : style avec polygone plein basé sur l'étape de réalisation de la ZAC  + nom de la ZAC à partir du 1/35000

  Historique des versions :
  date        |  auteur              |  description
  02/03/2017  |  Arnaud LECLERE      |  version initiale
  14/03/2017  |  Maël REBOUX         |  mise en forme + éch affichage + style nom des ZAC
...
xmlns:ogc="http://www.opengis.net/ogc" xmlns:se="http://www.opengis.net/se" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance">
  <NamedLayer>
    ...
    <UserStyle>
      <se:Name>zac_bordure_plg</se:Name>
      <se:Description>
        <se:Title>Étapes de réalisation de la ZAC (bordures seules)</se:Title>
        <se:Abstract>style (avec uniquement les bordures des polygones) basé sur l'étape de réalisation de la ZAC.</se:Abstract>
      </se:Description>
      <se:FeatureTypeStyle>
