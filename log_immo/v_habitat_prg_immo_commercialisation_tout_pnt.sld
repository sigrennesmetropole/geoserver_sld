...
<!--
  ...
  nom du SLD : v_habitat_prg_immo_commercialisation_tout_pnt
...
<sld:StyledLayerDescriptor 
  ...
  <sld:NamedLayer>
    ...
    <sld:UserStyle>
      <sld:Name>v_habitat_prg_immo_commercialisation_tout_pnt</sld:Name>
      <sld:Title>Etat de la commercialisation</sld:Title>
      <sld:Abstract>Ce style permet de voir la localisation de tous les programmes immobiliers sur Rennes Métropole.</sld:Abstract>
      <sld:FeatureTypeStyle>
        ...
        <sld:Rule>
          ...
          <sld:Title>Commercialisation achevée</sld:Title>
          <ogc:Filter>
            <ogc:PropertyIsEqualTo>
              <ogc:PropertyName>publication</ogc:PropertyName>
