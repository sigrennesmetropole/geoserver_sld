...
xmlns:ogc="http://www.opengis.net/ogc" xmlns:se="http://www.opengis.net/se" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance">
  <NamedLayer>
    <se:Name>Couche d'OCcupation du Sol à Grande Echelle (OCSGE) - Usage du sol </se:Name>
    <UserStyle>
      <se:Name>OCcupation du Sol à Grande Echelle (OCSGE) - Usage du sol </se:Name>
      <se:Description>
        <se:Title>OCSGE - Usage du sol</se:Title>
        <se:Abstract>OCcupation du Sol à Grande Echelle (OCSGE) - Usage du sol</se:Abstract>
      </se:Description>       
