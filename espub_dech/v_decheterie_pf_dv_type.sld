...
xmlns:ogc="http://www.opengis.net/ogc" xmlns:se="http://www.opengis.net/se" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance">
  <NamedLayer>
    ...
    <UserStyle>
      <se:Name>v_decheterie_pf_dv_type</se:Name>
      <se:Description>
        <se:Title>Type de déchèteries ou plate-forme végétaux</se:Title>
        <se:Abstract>Type de déchèteries ou plate-forme végétaux</se:Abstract>
      </se:Description>
      <se:FeatureTypeStyle>
