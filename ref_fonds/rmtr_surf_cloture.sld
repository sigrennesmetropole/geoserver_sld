...
<!--
  ...
  nom du SLD : rmtr_surf_cloture
  
  couche source dans la base :  toposurf.v_clotu_mat
  layer cible du style       :  ref_topo:rmtr_surf_cloture
  
  objet :  Style relatif aux objets de cloture de surface.
...
<StyledLayerDescriptor version="1.1.0" 
 ...
 <NamedLayer>
    <se:Name>v_clotu_mat</se:Name>
    <UserStyle>
     <se:Name>rmtr_surf_cloture</se:Name>
     <se:Description>        
