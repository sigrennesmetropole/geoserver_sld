...
<StyledLayerDescriptor version="1.1.0" 
  ...
  <NamedLayer>
    <se:Name>ref_fonds:vgs_troncon_automixte_classe2</se:Name>

    <UserStyle>
      <se:Name>top25_voie_classe_2_niv_1_lgn</se:Name>

      <se:Description>
        <se:Title>Voie communale principale hors agglomération</se:Title>
        <se:Abstract>Style de lignes aux couleurs de voies communales principales hors agglomération de niveaux -1.</se:Abstract>
      </se:Description> 
      ...
      <se:FeatureTypeStyle>
        ...
        <se:Rule>
          <se:Name>Voies jaunes - niveau -1</se:Name>
