...
<StyledLayerDescriptor version="1.1.0" 
  ...
  <NamedLayer>
    ...
    <UserStyle>
      <se:Name>top25_voie_classe_2_niv2_lgn</se:Name>

      <se:Description>
        <se:Title>Voie communale principale hors agglomération</se:Title>
        <se:Abstract>Style de lignes aux couleurs de voies communales principales hors agglomération de niveaux 2.</se:Abstract>
      </se:Description> 
      ...
      <se:FeatureTypeStyle>
        ...
        <se:Rule>
          <se:Name>Voies jaunes - niveau 2</se:Name>
