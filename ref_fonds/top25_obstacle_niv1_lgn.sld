...
<!--
  ...
  nom du SLD : top25_obstacle_niv1_lgn

  couche source dans la base :  bdu.donnees_gen.obstacle
  layer cible du style       :  ref_fonds:pvci_obstacle_lgn

  objet : Style de lignes des obstacles infranchissables des voies routières de Rennes Métropole (niveau 1).
...
<StyledLayerDescriptor version="1.1.0" 
  ...
  <NamedLayer>
    ...
    <UserStyle>
      <se:Name>top25_obstacle_niv1_lgn</se:Name>

      <se:Description>
        <se:Title>Obstacles infranchissables issus du PVCI - niveau 1</se:Title>
