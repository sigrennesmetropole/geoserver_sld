...
<!--
  ...
  nom du SLD : top25_voie_classe_1_niv3_lgn

  couche source dans la base :  rva.v_troncon_lgn
  layer cible du style       :  ref_fonds:vgs_troncon_automixte_classe1

  objet : Voie structurant l'aire urbaine ou ceinture de desserte - niveau 3
...
<StyledLayerDescriptor version="1.1.0"
  ...
  <NamedLayer>
    ...
    <UserStyle>
      <se:Name>top25_voie_classe_1_niv3_lgn</se:Name>
      <se:Description>
        <se:Title>Voie structurant l'aire urbaine ou ceinture de desserte</se:Title>
        <se:Abstract>Style de lignes aux couleurs de voies structurant l'aire urbaine ou ceinture de desserte de niveaux 3.</se:Abstract>
      </se:Description>
