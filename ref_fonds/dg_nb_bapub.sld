...
<!--
  ...
  nom du SLD : dg_nb_bapub
  
  couche source dans la base :  donnees_gen.v_bapub
  layer cible du style       :  ref_fonds : v_bapub
  
  objet :  Style niveau de gris relatif aux Bâtiments publics de Rennes.
 ...
 <NamedLayer>
    ...
    <UserStyle>
     ...
     <se:Description>        
        ...
        <se:Abstract>Style niveau de gris des bâtiments publics de Rennes</se:Abstract>
     </se:Description>
     <se:FeatureTypeStyle>
         <se:Rule>
