...
<StyledLayerDescriptor version="1.1.0" 
  ...
  <NamedLayer>
    <se:Name>ref_fonds:vgs_troncon_automixte_classe3</se:Name>

    <UserStyle>
      <se:Name>top25_voie_classe_3_niv_1_lgn</se:Name>

      <se:Description>
        <se:Title>Voie inter quartier</se:Title>
        <se:Abstract>Style de lignes aux couleurs de voies inter quartiers de niveaux -1.</se:Abstract>
      </se:Description> 
