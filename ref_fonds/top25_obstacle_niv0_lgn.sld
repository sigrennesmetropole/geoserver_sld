...
<!--
  ...
  nom du SLD : top25_obstacle_niv0_lgn

  couche source dans la base :  bdu.donnees_gen.obstacle
  layer cible du style       :  ref_fonds:pvci_obstacle_lgn

  objet : Style de lignes des obstacles infranchissables des voies routières de Rennes Métropole (niveau 0).
...
<StyledLayerDescriptor version="1.1.0" 
  ...
  <NamedLayer>
    ...
    <UserStyle>
      <se:Name>top25_obstacle_niv0_lgn</se:Name>

      <se:Description>
        <se:Title>Obstacles infranchissables issus du PVCI - niveau 0</se:Title>
