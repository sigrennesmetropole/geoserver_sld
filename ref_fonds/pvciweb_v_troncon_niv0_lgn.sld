...
<!--
  ...
  nom du SLD : pvciweb_v_troncon_niv0_lgn
  ...
  objet : affichage web niveau de gris des voies de niveau 0 selon la hiérarchisation
      ...
      <FeatureTypeStyle>    
         <Rule>   
             <ogc:Filter>
              ...
              <LineSymbolizer>
                     <Stroke>
                       <CssParameter name="stroke">#EED3FC</CssParameter>
