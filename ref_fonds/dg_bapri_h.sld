...
<!--
  ...
  nom du SLD : dg_bapri_h

  couche source dans la base :  donnees_gen.v_bapri_h
  layer cible du style       :  ref_fonds:dg_bapri_h

  objet :  Style relatif aux détails des bâtiments privés de Rennes.
...
<StyledLayerDescriptor version="1.1.0"
  ...
  <NamedLayer>
    <se:Name>ref_fonds:dg_bapri_h</se:Name>
    <UserStyle>
      <se:Name>dg_bapri_h</se:Name>
      <se:Description>
        <se:Title>Détails des bâtiments privés</se:Title>
        <se:Abstract>Style des détails des bâtiments privés de Rennes</se:Abstract>
      </se:Description>
      <se:FeatureTypeStyle>
