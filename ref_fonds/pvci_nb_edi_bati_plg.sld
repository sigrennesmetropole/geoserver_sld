...
<!--
  ...
  15/06/2015  |  S. GELIN   |  version initiale
  23/08/2017  |  S. GELIN   |  intégration Données Générales
    ...
    <UserStyle>
      <se:Name>pvci_edi_bati_plg</se:Name>
        <se:Description>
          ...
          <se:Abstract>Style niveau de gris des Bâtiments du PVCI (source : cadastre)</se:Abstract>
        </se:Description>
      <se:FeatureTypeStyle>
