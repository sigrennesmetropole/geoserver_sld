...
<!--
  ...
  nom du SLD : dg_nb_bapri
  
  couche source dans la base :  donnees_gen.v_bapri
  layer cible du style       :  ref_fonds : v_bapri
  
  objet :  Style niveau de gris relatif aux bâtiments privés de Rennes.
 ...
 <NamedLayer>
    ...
    <UserStyle>
     ...
     <se:Description>        
        ...
        <se:Abstract>Style niveau de gris des bâtiments privés de Rennes</se:Abstract>
     </se:Description>
     <se:FeatureTypeStyle>
         <se:Rule>
