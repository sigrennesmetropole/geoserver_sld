...
<!--
  ...
  on utilise l'attribut "adresse" qui permet d'etiqueter de la sorte : '66 bis A'
  /!\ ce style est à maintenir en parallèle de ref_rva: v_adresse_etq.sld
...
xmlns:ogc="http://www.opengis.net/ogc" xmlns:se="http://www.opengis.net/se" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance">
  <NamedLayer>
    ...
    <UserStyle>
      <se:Name>pvci_v_adresse_etq</se:Name>
        <se:Description>
