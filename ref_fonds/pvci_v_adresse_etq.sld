...
<!--
  ...
  layer cible du style       :  ref_fonds:pvci_v_adresse_pnt  utilisé dans les aggrégats ref_fonds:pvci / pvci_nb / pvci_nb

  objet :
  étiquettes des adresses
  on utilise l'attribut "adresse" qui permet d'étiqueter de la sorte : '66 bis A'
  /!\ ce style est une copie de ref_rva: v_adresse_etq.sql

  Historique des versions :
  date        |  auteur              |  description
  01/12/2016  |  Maël REBOUX         |  version initiale dérivée du style ref_rva:v_adresse_etq
...
<StyledLayerDescriptor version="1.0.0"
  ...
  <NamedLayer>
    <Name>ref_fonds:pvci_v_adresse_pnt</Name>
    <UserStyle>
