...
<!--
  ...
  nom du SLD : dg_bapub_p
  
  couche source dans la base :  donnees_gen.v_bapub_p
  layer cible du style       :  ref_fonds : v_bapub_p
  
  objet :  Style relatif aux Porches des bâtiments publics de Rennes.
...
<StyledLayerDescriptor version="1.1.0" 
  ...
  <NamedLayer>
    <se:Name>v_bapub_p</se:Name>
    <UserStyle>
      <se:Name>dg_bapub_p</se:Name>
      <se:Description>        
        <se:Title>Porches des bâtiments publics </se:Title>
        <se:Abstract>Style des Porches des bâtiments publics de Rennes</se:Abstract>
      </se:Description>
      <se:FeatureTypeStyle>
