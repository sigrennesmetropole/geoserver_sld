...
<StyledLayerDescriptor version="1.1.0" 
  ...
  <NamedLayer>
    ...
    <UserStyle>
      <se:Name>top25_voie_classe_4_niv0_lgn</se:Name>

      <se:Description>
        <se:Title>Voie de desserte locale</se:Title>
        <se:Abstract>Style de lignes aux couleurs de voies de dessertes locales de niveaux 0.</se:Abstract>
      </se:Description> 
      ...
      <se:FeatureTypeStyle>
        ...
        <se:Rule>
          <se:Name>Voies blanches - niveau 0</se:Name>
