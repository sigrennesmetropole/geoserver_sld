...
<StyledLayerDescriptor version="1.1.0" 
  ...
  <NamedLayer>
    ...
    <UserStyle>
      <se:Name>top25_voie_classe_3_niv2_lgn</se:Name>

      <se:Description>
        <se:Title>Voie inter quartier</se:Title>
        <se:Abstract>Style de lignes aux couleurs de voies inter quartiers de niveaux 2.</se:Abstract>
      </se:Description> 
