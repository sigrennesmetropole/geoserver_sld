...
<!--
  ...
  nom du SLD : dg_nb_itopo_negatif_fond_extra
...
<StyledLayerDescriptor version="1.1.0"
  ...
  <NamedLayer>
    ...
    <UserStyle>
      ...
      <se:Description>
        <se:Title>complément des ilots topo sur secteur extra rocade : gris large</se:Title>
        <se:Abstract/>
      </se:Description>

      <!-- secteur 2 = extra-rocade : on affiche le buffer extérieur de la même couleur que les ilots topo (gris clair) -->
      <se:FeatureTypeStyle>
        <se:Rule>
          <ogc:Filter>
            <ogc:And>
