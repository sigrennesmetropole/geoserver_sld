...
<!--
  ...
  nom du SLD : bruit_routier_seuil_2010_Lden

  couche source dans la base :  risque_secu.bruit_seuil_2010
  layer cible du style       :  sec_sanit:bruit_routier_seuil_2010_lden

  objet :  Style relatif aux Dépassements de seuil routier (jour, soirée, nuit)
...
<StyledLayerDescriptor version="1.1.0"
  ...
  <NamedLayer>
    <se:Name>sec_sanit:bruit_routier_seuil_2010_lden</se:Name>
    <UserStyle>
      <se:Name>Dépassements de seuil routier(LDEN)</se:Name>
      <se:Description>
        <se:Title>Dépassements de seuil routier(LDEN)</se:Title>
        <se:Abstract>Style relatif Dépassements de seuil routier </se:Abstract>
      </se:Description>
      ...
      <!-- entre 72 dBA et 75 dBA -->
      <se:FeatureTypeStyle>
        <se:Rule>
          <se:Name>72 dBA - 75 dBA</se:Name>
          <ogc:Filter xmlns:ogc="http://www.opengis.net/ogc">
              <ogc:PropertyIsEqualTo>
                <ogc:PropertyName>to_</ogc:PropertyName>
      ...
      <!-- entre 66 dBA et 71 dBA -->
      <se:FeatureTypeStyle>
        <se:Rule>
          <se:Name>66 dBA - 71 dBA</se:Name>
          <ogc:Filter xmlns:ogc="http://www.opengis.net/ogc">
              <ogc:PropertyIsEqualTo>
                <ogc:PropertyName>to_</ogc:PropertyName>
