...
<!--
  ...
  nom du SLD : bruit_routier_habitation_2010_Len

  couche source dans la base :  risque_secu.bruit_habitation_2010
  layer cible du style       :  sec_sanit:bruit_routier_habitation_2010

  objet :  Style relatif aux habitations de Rennes Métropole impactées par le bruit routier (soirée, nuit)
...
<StyledLayerDescriptor version="1.1.0"
  ...
  <NamedLayer>
    ...
    <UserStyle>
      <se:Name>Bruit routier: Habitations impactées par le bruit(LN)</se:Name>
      <se:Description>
        <se:Title>Bruit routier: Habitations impactées par le bruit(LN)</se:Title>
