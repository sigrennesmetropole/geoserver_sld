...
<!--
  ...
  nom du SLD : bruit_ferre_isophone_2010_Lden

  couche source dans la base :  risque_secu.bruit_isophone_2010
  layer cible du style       :  sec_sanit:bruit_ferre_isophone_2010

  objet :  Style relatif aux isophones du bruit ferré (jour, soirée, nuit)
...
<StyledLayerDescriptor version="1.1.0"
  ...
  <NamedLayer>
    <se:Name>sec_sanit:bruit_ferre_isophone_2010</se:Name>
    <UserStyle>
      <se:Name>Bruit ferré: Isophones(LDEN)</se:Name>
      <se:Description>
        <se:Title>Bruit ferré: Isophones(LDEN)</se:Title>
        <se:Abstract>Style relatif aux isophones du bruit ferré</se:Abstract>
      </se:Description>
