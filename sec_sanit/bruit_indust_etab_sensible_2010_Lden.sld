...
<!--
  ...
  nom du SLD : bruit_indust_etab_sensible_2010_Lden
  ...
  objet :  Style relatif aux Etablissements sensibles de Rennes Métropole impactés par le bruit industriel(jour, soirée, nuit)
...
<StyledLayerDescriptor version="1.1.0"
  ...
  <NamedLayer>
    ...
    <UserStyle>
      <se:Name>Bruit industriel: Etablissements sensibles impactés par le bruit industriel(LDEN)</se:Name>
      <se:Description>
        <se:Title>Bruit industriel: Etablissements sensibles impactés par le bruit industriel (LDEN)</se:Title>
