...
<StyledLayerDescriptor version="1.1.0"
  ...
  <NamedLayer>
    ...
    <UserStyle>
      <se:Name>Bruit aérien: Isophones(LN)</se:Name>
      <se:Description>
        <se:Title>Bruit aérien: Isophones(LN)</se:Title>
