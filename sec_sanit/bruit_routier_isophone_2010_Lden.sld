...
<!--
  ...
  nom du SLD : bruit_routier_isophone_2010_Lden

  couche source dans la base :  risque_secu.bruit_isophone_2010
  layer cible du style       :  sec_sanit:bruit_routier_isophone_2010

  objet :  Style relatif aux isophones du bruit routier(jour, soirée, nuit) 
...
<StyledLayerDescriptor version="1.1.0"
  ...
  <NamedLayer>
    <se:Name>sec_sanit:bruit_routier_isophone_2010</se:Name>
    <UserStyle>
      <se:Name>Bruit routier: Isophones(LDEN)</se:Name>
      <se:Description>
        <se:Title>Bruit routier: Isophones(LDEN)</se:Title>
        <se:Abstract>Style relatif aux isophones du bruit routier </se:Abstract>
      </se:Description>
          ...
          <ogc:Filter xmlns:ogc="http://www.opengis.net/ogc">
            <ogc:And>
              ...
              <ogc:PropertyIsEqualTo>
                ...
                <ogc:Literal>Routier</ogc:Literal>
              </ogc:PropertyIsEqualTo>               
              <ogc:PropertyIsEqualTo>
