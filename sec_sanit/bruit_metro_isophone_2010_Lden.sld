...
<StyledLayerDescriptor version="1.1.0"
  ...
  <NamedLayer>
    ...
    <UserStyle>
      <se:Name>Bruit métro: Isophones(LDEN)</se:Name>
      <se:Description>
        <se:Title>Bruit métro: Isophones(LDEN)</se:Title>
