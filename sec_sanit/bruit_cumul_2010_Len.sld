...
<!--
  ...
  nom du SLD : bruit_cumul_2010_Len

  couche source dans la base :  risque_secu.bruit_cumul_2010
  layer cible du style       :  sec_sanit:bruit_cumul_2010

  objet :  Style relatif au Cumul des différentes sources de bruit (soirée, nuit)
...
<StyledLayerDescriptor version="1.1.0"
  ...
  <NamedLayer>
    ...
    <UserStyle>
      <se:Name>Bruit : Cumul des différentes sources de bruit (LEN)</se:Name>
      <se:Description>
        <se:Title>Bruit : Cumul des différentes sources de bruit (LEN)</se:Title>
