...
<!--
  ...
  nom du SLD : bruit_metro_seuil_2010_Lden

  couche source dans la base :  risque_secu.bruit_seuil_2010
  layer cible du style       :  sec_sanit:bruit_metro_seuil_2010_lden

  objet :  Style relatif aux Dépassements de seuil métro (jour, soirée, nuit)
...
<StyledLayerDescriptor version="1.1.0"
  ...
  <NamedLayer>
    <se:Name>sec_sanit:bruit_metro_seuil_2010_lden</se:Name>
    <UserStyle>
      <se:Name>Dépassements de seuil métro (LDEN)</se:Name>
      <se:Description>
        <se:Title>Dépassements de seuil métro (LDEN)</se:Title>
