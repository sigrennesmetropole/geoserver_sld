...
<!--
  ...
  nom du SLD : bruit_aerien_isophone_2010_Lden

  couche source dans la base :  risque_secu.bruit_isophone_2010
  layer cible du style       :  sec_sanit:bruit_aerien_isophone_2010

  objet :  Style relatif aux isophones du bruit aérien(jour, soirée, nuit) 
...
<StyledLayerDescriptor version="1.1.0"
  ...
  <NamedLayer>
    <se:Name>sec_sanit:bruit_aerien_isophone_2010</se:Name>
    <UserStyle>
      <se:Name>Bruit aérien: Isophones(LDEN)</se:Name>
      <se:Description>
        <se:Title>Bruit aérien: Isophones(LDEN)</se:Title>
        <se:Abstract>Style relatif aux isophones du bruit aérien </se:Abstract>
      </se:Description>
