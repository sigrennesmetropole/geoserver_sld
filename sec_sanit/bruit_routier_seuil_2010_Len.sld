...
<!--
  ...
  nom du SLD : bruit_routier_seuil_2010_Len

  couche source dans la base :  risque_secu.bruit_seuil_2010
  layer cible du style       :  sec_sanit:bruit_routier_seuil_2010_len

  objet :  Style relatif aux Dépassements de seuil routier (soirée, nuit)
...
<StyledLayerDescriptor version="1.1.0"
  ...
  <NamedLayer>
    <se:Name>sec_sanit:bruit_routier_seuil_2010_len</se:Name>
    <UserStyle>
      <se:Name>Dépassements de seuil routier(LEN)</se:Name>
      <se:Description>
        <se:Title>Dépassements de seuil routier(LEN)</se:Title>
