...
<StyledLayerDescriptor version="1.1.0"
  ...
  <NamedLayer>
    ...
    <UserStyle>
      <se:Name>Bruit ferré: Isophones(LN)</se:Name>
      <se:Description>
        <se:Title>Bruit ferré: Isophones(LN)</se:Title>
