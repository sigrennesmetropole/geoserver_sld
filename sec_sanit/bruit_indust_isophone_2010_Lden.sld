...
<!--
  ...
  nom du SLD : bruit_indust_isophone_2010_Lden

  couche source dans la base :  risque_secu.bruit_isophone_2010
  layer cible du style       :  sec_sanit:bruit_indust_isophone_2010

  objet :  Style relatif aux isophones du bruit industriel(jour, soirée, nuit) 
...
<StyledLayerDescriptor version="1.1.0"
  ...
  <NamedLayer>
    <se:Name>sec_sanit:bruit_indust_isophone_2010</se:Name>
    <UserStyle>
      <se:Name>Bruit industriel: Isophones(LDEN)</se:Name>
      <se:Description>
        <se:Title>Bruit industriel: Isophones(LDEN)</se:Title>
        <se:Abstract>Style relatif aux isophones du bruit industriel</se:Abstract>
      </se:Description>
          ...
          <ogc:Filter xmlns:ogc="http://www.opengis.net/ogc">
            <ogc:And>
              ...
              <ogc:PropertyIsEqualTo>
                ...
                <ogc:Literal>Industriel</ogc:Literal>
              </ogc:PropertyIsEqualTo>               
              <ogc:PropertyIsEqualTo>
