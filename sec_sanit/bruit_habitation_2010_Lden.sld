...
<!--
  ...
  nom du SLD : bruit_habitation_2010_Lden

  couche source dans la base :  risque_secu.bruit_habitation_2010
  layer cible du style       :  sec_sanit:bruit_habitation_2010

  objet :  Style relatif aux habitations de Rennes Métropole impactés par le bruit (jour, soirée, nuit)
...
<StyledLayerDescriptor version="1.1.0"
  ...
  <NamedLayer>
    ...
    <UserStyle>
      <se:Name>Bruit : habitations impactés par le bruit (LDEN)</se:Name>
      <se:Description>
        <se:Title>Bruit : habitations impactés par le bruit LDEN)</se:Title>
