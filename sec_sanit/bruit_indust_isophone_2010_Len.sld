...
<StyledLayerDescriptor version="1.1.0"
  ...
  <NamedLayer>
    ...
    <UserStyle>
      <se:Name>Bruit industriel: Isophones(LN)</se:Name>
      <se:Description>
        <se:Title>Bruit industriel: Isophones(LN)</se:Title>
