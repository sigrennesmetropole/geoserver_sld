...
<!--
  ...
  nom du SLD : bruit_ferre_habitation_2010_Len

  couche source dans la base :  risque_secu.bruit_habitation_2010
  layer cible du style       :  sec_sanit:bruit_ferre_habitation_2010

  objet :  Style relatif aux habitations de Rennes Métropole impactées par le bruit ferré (soirée, nuit)
...
<StyledLayerDescriptor version="1.1.0"
  ...
  <NamedLayer>
    ...
    <UserStyle>
      <se:Name>Bruit ferré: habitations impactées par le bruit ferré(LN)</se:Name>
      <se:Description>
        <se:Title>Bruit ferré: habitations impactées par le bruit ferré(LN)</se:Title>
