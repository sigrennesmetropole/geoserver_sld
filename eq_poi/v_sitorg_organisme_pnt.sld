...
<!--
  ...
  nom du SLD : v_sitorg_organisme_pnt
  ...
  21/12/2017  |  Maël REBOUX         |  version initiale
...
xmlns:ogc="http://www.opengis.net/ogc" xmlns:se="http://www.opengis.net/se" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance">
  <NamedLayer>
    ...
    <UserStyle>
      <se:Name>v_sitorg_organisme_pnt</se:Name>
      <se:Description>
        <se:Title>Point violet et étiquettes</se:Title>
        <se:Abstract>Point violet sans distinction de nomenclature + étiquettes avec le nom de l'organisme à partir du 1/9000. Plusieurs organismes peuvent être superposés.</se:Abstract>
      </se:Description>
      <se:FeatureTypeStyle>
