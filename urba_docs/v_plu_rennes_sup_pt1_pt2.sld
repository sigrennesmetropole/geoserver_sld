...
<!--
  ...
  nom du SLD : v_plu_rennes_sup_pt1_pt2
  
  couche source dans la base :  urba_foncier..v_plu_rennes_info_pct et urba_foncier.v_plu_rennes_info_surf
  layer cible du style       :  urba_docs:v_plu_rennes_pt1_pt2
  
  objet :
   servitudes radioélectriques sur Rennes Métropole (PT1-PT2) - PLU de Rennes
  
  Historique des versions :
  date        |  auteur              |  description
  21/03/2019  |  S GELIN             |  version initiale
-->
<StyledLayerDescriptor version="1.1.0" xsi:schemaLocation="http://www.opengis.net/sld StyledLayerDescriptor.xsd" xmlns="http://www.opengis.net/sld" 
xmlns:ogc="http://www.opengis.net/ogc" xmlns:se="http://www.opengis.net/se" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance">
  <NamedLayer>
    <se:Name>urba_docs:v_plu_rennes_pt1_pt2</se:Name>
    <UserStyle>
      <se:Name>v_plu_rennes_sup_pt1_pt2</se:Name>
        <se:Description>
          <se:Title>servitudes radioélectriques sur Rennes Métropole (PT1-PT2) - PLU de Rennes</se:Title>
        </se:Description>
