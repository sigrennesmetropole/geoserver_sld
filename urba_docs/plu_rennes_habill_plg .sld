...
<!--
  ...
  22/03/2019  |  Maël REBOUX         |  visibilité élargie
...
<StyledLayerDescriptor version="1.1.0"
  ...
  <NamedLayer>
    ...
    <UserStyle>
      ...
      <se:Description>
        <se:Title>Habillage surfacique des documents d'urbanisme numérisés</se:Title>
        <se:Abstract>Habillage surfacique des documents d'urbanisme numérisés</se:Abstract>
      </se:Description>
      <se:FeatureTypeStyle>
